    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 py-8 animate-fade-in-up">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                ...
                {/* Seletor de Mês Super Aprimorado */}
                <div className="flex items-center space-x-3 bg-blue-50 dark:bg-gray-800 p-3 rounded-xl shadow-md border-2 border-blue-400 dark:border-blue-500 transition-colors cursor-pointer hover:border-blue-500 min-w-[200px] justify-center">
                    <svg className="w-7 h-7 text-blue-700 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                    <input
                        type="month"
                        value={selectedMonth}
                        onChange={(e) => {
                        ...
                        className="bg-transparent border-none focus:ring-0 text-blue-900 dark:text-white font-black text-lg outline-none cursor-pointer uppercase"
