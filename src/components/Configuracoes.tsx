...
const Configuracoes: React.FC<ConfiguracoesProps> = ({
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 py-8 animate-fade-in-up">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-8 text-center lg:text-left">ConfiguraÃ§Ãµes do Sistema</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700 h-fit">
                    ...
                    <form className="space-y-4">
                        ...
                        <button type="button" onClick={handleSaveProfile} className="w-full px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-bold shadow-md hover:shadow-blue-500/30 transition-all">Salvar AlteraÃ§Ãµes</button>
                    </form>
                </div>
                ...
                <div className="space-y-8">
                    ...
                    {/* 1. PersonalizaÃ§Ã£o do TEMA (Destaques) */}
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
                        <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-6 flex items-center">
                            ...
                            PersonalizaÃ§Ã£o do Tema (BotÃµes e Menu)
                        </h2>
                        <div className="mb-6">
                            ...
                            <button type="button" onClick={() => onUpdateTheme('blue')} className="text-sm text-blue-600 hover:underline font-medium">Restaurar Tema PadrÃ£o</button>
                        </div>
                    </div>

                    {/* 2. PersonalizaÃ§Ã£o do FUNDO (Tela) */}
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
                        <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-6 flex items-center">
                            ...
                            PersonalizaÃ§Ã£o do Fundo (Tela)
                        </h2>
                        <div className="mb-6">
                            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Escolha a cor de fundo da Ã¡rea de trabalho:</p>
                            <div className="flex flex-wrap gap-4 mb-4">
