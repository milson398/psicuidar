...
const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
    ...
    return (
        ...
        >
            ...
            <div 
                className="hidden lg:flex lg:w-1/2 relative min-h-screen overflow-hidden bg-slate-900 border-r border-white/5"
                style={{ display: 'flex', width: '50%', position: 'relative' }}
            >
