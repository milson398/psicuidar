                                                        ...
                                                        {p.status === 'Pendente' && (
                                                            <>
                                                                <button
                                                                    ...
                                                                    className="px-3 py-1.5 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-lg text-xs font-bold flex items-center transition-all transform active:scale-95 shadow-sm"
